...
router.post('/', [
  ...
  const { id_corporate, type_user, name_user, cpf, rg, phone, email, password, verify } = request.body;
  ...
  try {
    await db.insertUser(id_corporate, type_user, name_user, cpf, rg, phone, email, password, verify);
  }
  catch (err) {
...
router.put('/', [
  ...
  const { id_corporate, type_user, name_user, cpf, rg, phone, email, password, verify, id } = request.body;

  try {
    await db.upadateUser(id_corporate, type_user, name_user, cpf, rg, phone, email, password, verify, id);
